...
begin	-- arch struct
	...
	begin
		...
		for i in 0 to 15 loop
			...
			kk := dec7seg(tb_cnt); -- = 72 when cnt = 12  => incorrect. it has to be 31 , according to the LUT   (whereas tb_segout is correct) ==> which means dec7seg() is not implemented correctly !
