...
architecture struct of tb is  -- TODO : warum struct ? ist das nicht Verhaltensbeschriebung ?
...
begin
	...
	clk_process: process   -- TODO : this process keeps repeating during the simulation time ?
	begin
		tb_clk <= '0';
	...
	begin
		...
		-- ...
		wait; -- TODO : wait till end of simulation ?
	end process;
