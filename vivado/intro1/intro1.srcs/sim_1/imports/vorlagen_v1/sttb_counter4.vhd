-- Self-testing testbench for counter4
...
begin	-- struct
	...
	-- TODO :  is this process called only one time during the whole simulation ? compared to other processes
	...
	begin
		...
		assert (to_integer(unsigned(tb_q_out)) = 0) report "q_out value wrong" severity failure;
